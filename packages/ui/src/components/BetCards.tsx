...
> = {
  en: {
    ...
    pointsHint: 'Bids are points, not tricks — 10 in play each round.',
    explainToggle: 'What do the numbers mean?',
    explainLines: [
      'Each trick is worth 1 point · the Red 0 adds 5 · the Brown 0 removes 3 — 10 in total.',
  ...
  fr: {
    ...
    hailMaryWarn:
      'Tout ou rien — réussis 12 sans atout et tu gagnes; rate-la et tu perds la partie.',
    pointsHint: 'Les mises sont des points, pas des levées — 10 en jeu par ronde.',
    explainToggle: 'Que veulent dire les chiffres?',
    explainLines: [
      'Chaque levée vaut 1 point · le Rouge 0 ajoute 5 · le Brun 0 enlève 3 — 10 au total.',
