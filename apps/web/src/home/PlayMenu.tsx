    ...
    >
      ...
      {resumeCode !== null && (
        <a
          ...
          className="rise-in flex items-center justify-center gap-2 px-4 py-3 text-(length:--text-fluid-sm) text-(--color-ap-muted) hover:text-(--color-ap-text) sm:col-span-2"
        ...
        >
          ...
          Resume last room ·{' '}
          <span className="font-arcade-display uppercase tracking-wide text-(--color-ap-gold)">
            {resumeCode}
          </span>
        </a>
      )}
